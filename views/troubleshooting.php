...
echo '<div class="mo_lms_divided_layout">
	        <div class="mo_lms_setting_layout">
        <h3>
        	Frequenty Asked Questions
        	<div style="float: right;">
                <a class="mo_lms_button mo_lms_button1" href="' . esc_url( $two_fa ) . '">Back</a> 
            </div>
        </h3><br><hr>
			<table class="mo_lms_help">
						<tbody><tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_curl_title" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">How to enable PHP cURL extension? (Pre-requisite)</div>
								</div>
								<span hidden="" id="mo_lms_help_curl_desc" class="mo_lms_help_desc" style="display: none;">
								<ol>
							...
							<td class="mo_lms_help_cell">
								<div id="mo_lms_issue_in_scanning_QR" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I am facing issue in scanning QR code, what is the reason behind the error?</div>
								</div>
								<span hidden="" id="mo_lms_issue_in_scanning_QR_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_particular_use_role" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I want to enable 2-factor for particular user roles in WordPress, how do I do that?</div>
								</div>
								<div hidden="" id="mo_lms_help_particular_use_role_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_enforce_MFA" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I want to Enforce my users to configure the Two-factor authentication method how I do that?</div>
								</div>
								<div hidden="" id="mo_lms_help_enforce_MFA_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_reset_MFA" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I want to reset Two Factor for my users, how I do that?</div>
								</div>
								<div hidden="" id="mo_lms_help_reset_MFA_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_get_back_to_account" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">How do I gain access to my website if I get locked out?</div>
								</div>
								<div hidden="" id="mo_lms_help_get_back_to_account_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_multisite" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">Does the miniOrange 2FA plugin support multi-site support?</div>
								</div>
								<div hidden="" id="mo_lms_help_multisite_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_forgot_password" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I forgot the password of my miniOrange account. How can I reset it?</div>
								</div>
								<div hidden="" id="mo_lms_help_forgot_password_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_MFA_propmted" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">My Users are not being prompted for 2-factor during login. Why?</div>
								</div>
								<div hidden="" id="mo_lms_help_MFA_propmted_solution" class="mo_lms_help_desc" style="display: none;">
							...
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_redirect_back" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">When I enter my authentication code and click on Validate, I got redirected back to the login page, Why is this happening?</div>
								</div>
								<div hidden="" id="mo_lms_help_redirect_back_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_alternet_login" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">I had setup QR Code Authentication/Push Notification as my 2-factor method. My phone has no internet connectivity, how can I login?</div>
								</div>
								<div hidden="" id="mo_lms_help_alternet_login_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_lost_ability" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">My phone is lost, stolen or discharged. How can I login?</div>
								</div>
								<div hidden="" id="mo_lms_help_lost_ability_solution" class="mo_lms_help_desc" style="display: none;">
						...
						<tr>
							<td class="mo_lms_help_cell">
								<div id="mo_lms_help_translate" class="mo_lms_title_panel">
									<div class="mo_lms_help_title">How do I translate the plugin in a language of my choice?</div>
								</div>
								<div hidden="" id="mo_lms_help_translate_solution" class="mo_lms_help_desc" style="display: none;">
