...
function molms_configure_google_authenticator_onprem( $secret, $url, $otpcode ) {
	$h_size     = 'h3';
    ...
    <table>
        <tr>
            <td class="mo2f_google_authy_step2">
				<?php echo '<' . esc_html( $h_size ) . '>' . esc_html( molms_lt( 'Step-1: Set up Google/Authy/LastPass Authenticator' ) ) . '<span style="float:right">
                ...
                <h4>
                    <span id="step_number"></span><?php echo esc_html( molms_lt( 'Scan the QR code from the Authenticator App.' ) ); ?>
                </h4>
                <div style="margin-left:40px;">
                    <ol>
                        <li><?php echo esc_html( molms_lt( 'In the app, tap on Menu and select "Set up account".' ) ); ?></li>
                        <li><?php echo esc_html( molms_lt( 'Select "Scan a barcode".' ) ); ?></li>
                            ...
                            <div style="margin-left: 14%;">
                                <div class="mo2f_gauth_column mo2f_gauth_left">
                                    ...
                                    <div class="mo2f_gauth" id="displayGAQrCodeTour" style="background: white;"
                                         data-qrcode="<?php echo esc_html( $url ); ?>"></div>
                                </div>
                            </div>

                            <div>
                                <input type="text" class="mo2f_table_textbox"
                                       style="margin-left: -1.5px;width: 32%;margin-top: 4%;" id="mo2f_change_app_name"
                                       name="mo2f_google_auth_appname" placeholder="Enter the app name"
                                       value="<?php echo esc_html( $gauth_name ); ?>"/>

                                <input type="submit" name="submit" value="Save App Name"
                                       class="mo_lms_button mo_lms_button1"
                                       style="padding: 6px 19px;margin-top: -0.1%;margin-left: -1.5px;width: 32%;"/>
                                <br>
                            </div>
                        </form>
                    ...
                    <div><a data-toggle="collapse" href="#mo2f_scanbarcode_a"
                            aria-expanded="false"><b><?php echo esc_html( molms_lt( 'Can\'t scan the barcode? ' ) ); ?></b></a>
                    </div>
                    <div class="mo2f_collapse" id="mo2f_scanbarcode_a" style="background: white;">
                        <ol class="mo2f_ol">
                            <li><?php echo esc_html( molms_lt( 'Tap on Menu and select' ) ); ?>
                                <b> <?php echo esc_html( molms_lt( ' Set up account ' ) ); ?></b>.
                            </li>
                            <li><?php echo esc_html( molms_lt( 'Select' ) ); ?>
                                <b> <?php echo esc_html( molms_lt( ' Enter provided key ' ) ); ?></b>.
                            </li>
                            <li><?php echo esc_html( molms_lt( 'For the' ) ); ?>
                                <b> <?php echo esc_html( molms_lt( ' Enter account name ' ) ); ?></b>
								<?php echo esc_html( molms_lt( 'field, type your preferred account name' ) ); ?>.
                            </li>
                            <li><?php echo esc_html( molms_lt( 'For the' ) ); ?>
                                <b> <?php echo esc_html( molms_lt( ' Enter your key ' ) ); ?></b>
								<?php echo esc_html( molms_lt( 'field, type the below secret key' ) ); ?>:
                            </li>
                            ...
                            <div class="mo2f_google_authy_secret_outer_div">
                                ...
                                <div class="mo2f_google_authy_secret">
									<?php echo esc_html( molms_lt( 'Spaces do not matter' ) ); ?>.
                                </div>
                            </div>
                            <li><?php echo esc_html( molms_lt( 'Key type: make sure' ) ); ?>
                                <b> <?php echo esc_html( molms_lt( ' Time-based ' ) ); ?></b>
								<?php echo esc_html( molms_lt( ' is selected' ) ); ?>.
                            </li>

                            <li><?php echo esc_html( molms_lt( 'Tap Add.' ) ); ?></li>
                        </ol>
                    </div>
                    <br>
                </div>
            ...
            <td class="mo2f_google_authy_step3">
                <h4><?php echo '<' . esc_html( $h_size ) . '>' . esc_html( molms_lt( 'Step-2: Verify and Save' ) ) . '</' . esc_html( $h_size ) . '>'; ?></h4>
                <hr>
                <div style="display: block;">
                    <div><?php echo esc_html( molms_lt( 'After you have scanned the QR code and created an account, enter the verification code from the scanned account here.' ) ); ?></div>
                    <br>
                    <form name="f" method="post" action="">
                        <span><b><?php echo esc_html( molms_lt( 'Code:' ) ); ?> </b>&nbsp;
                        <input class="mo2f_table_textbox" style="width:200px;" id="EnterOTPGATour" autofocus="true"
                               required="true"
                               type="text" name="google_token"
                        ...
                        <input type="submit" name="validate" id="SaveOTPGATour" class="mo_lms_button mo_lms_button1"
                               style="float:left;" value="<?php echo esc_html( molms_lt( 'Verify and Save' ) ); ?>"/>
                    </form>
	...
	<?php
	$q = isset( $_SERVER['REQUEST_TIME'] ) ? sanitize_text_field( $_SERVER['REQUEST_TIME'] ) * 1000 : 0; ?>
    <script>
