...
function molms_configure_google_authenticator( $user ) {
                ...
                <div style="margin-left:40px;">
                    <ol>
                        ...
                        <form name="f" id="login_settings_appname_form" method="post" action="">
                            ...
                            <div>
                                <input type="text" class="mo2f_table_textbox" id="mo2f_change_app_name"
                                       style="margin-left: -1.5px;width: 32%;margin-top: 4%;"
            ...
            <td class="mo2f_google_authy_step3">
                ...
                <div style="<?php echo isset( $_SESSION['mo2f_google_auth'] ) ? 'display:block' : 'display:none'; ?>">
                    ...
                    <form name="f" method="post" action="">
                        ...
                        <input id="EnterOTPGATour" class="mo2f_table_textbox" style="width:200px;" autofocus="true"
                               required="true"
