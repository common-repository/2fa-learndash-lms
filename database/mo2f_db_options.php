...
$GLOBALS['mo_lms_enable_ip_blocked_email_to_admin']        = false;
$GLOBALS['molms_activate_plugin']                          = 1;
...
$GLOBALS['mo_lms_scan_initialize']                         = 1;
$GLOBALS['mo_file_manual_backup_plugins']                  = 1;
$GLOBALS['mo_file_manual_backup_themes']                   = 1;
$GLOBALS['mo_schedule_database_backup']                    = 1;
$GLOBALS['mo_lms_2fa_with_network_security']               = 0;
$GLOBALS['mo_lms_2fa_with_network_security_popup_visible'] = 1;
$GLOBALS['mo2f_two_factor_tour']                           = - 1;
$GLOBALS['mo2f_planname']                                  = '';
$GLOBALS['molms_email_transactions']                       = 30;
$GLOBALS['molms_zero_email_transactions']                  = 0;
